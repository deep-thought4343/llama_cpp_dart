...
class LlamaChild extends IsolateChild<LlamaResponse, LlamaCommand> {
  ...
  void onData(LlamaCommand data) {
    switch (data) {
      ...
      case LlamaInit(:final libraryPath, :final backendSearchDir):
        _handleInit(libraryPath, backendSearchDir: backendSearchDir);
  ...
  /// Handle init command
  void _handleInit(String? libraryPath, {String? backendSearchDir}) {
    try {
      Llama.libraryPath = libraryPath;
      Llama.backendSearchDir = backendSearchDir;
      final _ = Llama.lib;
