...
class ModelParams {
  ...
  /// Default is [LlamaSplitMode.layer] to match the C default (LLAMA_SPLIT_MODE_LAYER).
  /// Using [LlamaSplitMode.none] on CPU-only systems will fail because
  /// it validates main_gpu against GPU device count (which is 0).
